...
DROP TYPE IF EXISTS temp_servire CASCADE;
...
CREATE TYPE temp_servire AS ENUM(
    'fierbinte', 
    'rece', 
    'temperatura camerei', 
    'cu gheata'
...
CREATE TABLE produse (
    ...
    temperatura_servire temp_servire,
    ingrediente VARCHAR[],
...
('Latte cu ciocolata', 'Un amestec echilibrat de espresso, lapte cremos și sirop fin de ciocolată.', 21.00, 300, 320, 'cafea/ceai', 'fusion', 'cu gheata', '{"espresso", "lapte", "sirop de ciocolata"}', False, 'latte-ciocolata.png'),
...
('Sushi cu somon', 'Clasicul maki cu somon proaspăt.', 30.00, 180, 750, 'sushi', 'traditional', 'rece', '{"orez", "alge nori", "somon crud"}', False, 'sushi-somon.png'),
...
('Sushi de paste', 'Sushi cu aroma de sarbatori pascale.', 35.00, 220, 510, 'sushi', 'sezon', 'temperatura camerei', '{"oua fierte", "alge nori", "crema de branza", "somon afumat"}', False, 'sushi-paste.png'),
...
('Cheesecake cu Matcha', 'Prăjitură cu cremă de brânză și pudră matcha.', 28.00, 200, 880, 'desert', 'fusion', 'rece', '{"crema de branza", "pudra matcha", "biscuiti", "unt", "zahar"}', False, 'cheesecake-matcha.jpg'),
...
UPDATE produse SET data_adaugare = '2025-11-10 10:00:00' WHERE nume = 'Special Matcha';
UPDATE produse SET data_adaugare = '2025-12-01 12:30:00' WHERE nume = 'Latte cu ciocolata';
UPDATE produse SET data_adaugare = '2025-09-15 14:00:00' WHERE nume = 'Sushi cu somon';
UPDATE produse SET data_adaugare = '2025-10-20 09:00:00' WHERE nume = 'Ciocolata calda';
UPDATE produse SET data_adaugare = '2025-08-05 08:00:00' WHERE nume = 'Americano Lung';
